...
import 'package:zomato_api/UI/widgets/bezier_container.dart';
          ...
          Expanded(
            ...
            child: InkWell(
              onTap: () {
                ...
                facebookLogin.logIn(['email', 'public_profile']).then((result) {
                  switch (result.status) {
                    case FacebookLoginStatus.loggedIn:
                      ...
                      FirebaseAuth.instance
                        ...
                        print('SignedIn as ${result.user.displayName}');
                        sharedPrefService.login();
                        Navigator.of(context).pop();
                    ...
                    case FacebookLoginStatus.error:
                      ...
                      final s = SnackBar(
                        content: Text(
                            'login error ! ${FacebookLoginStatus.error.toString()}'),                      );
                      Scaffold.of(context).showSnackBar(s);
                      break;
                  }
                }).catchError((e) {
